...
import org.docx4j.org.xhtmlrenderer.event.DocumentListener;
import org.docx4j.org.xhtmlrenderer.extend.UserAgentCallback;
import org.docx4j.org.xhtmlrenderer.resource.CSSResource;
 ...
 * {@link org.docx4j.org.xhtmlrenderer.event.DocumentListener#documentStarted()} call and attempt to shrink its cache.
 *
...
public class NaiveUserAgent implements UserAgentCallback, DocumentListener {
    ...
    protected InputStream resolveAndOpenStream(String uri) {
        ...
        if(uri.startsWith("data:image")){
        	String b64Image = uri.substring(uri.indexOf(",")+1);
