...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="glyphicon glyphicon-wrench"></i> Settings and Options
      <small></small>
    </h1>
  </section>
	  			...
	  			<bs:mco colsize="12">
	  				<bs:datatable columns="Name,Options" classname="" id="type">
	  					<s:iterator value="types">
	  						<tr><td><s:property value="type"/></td>
	  						<td width="100px">
	  							<span onclick="editType(this,${id })" class="vulnControl">
	  								<i class="fa fa-edit"></i>
	  							</span>
	  							<span onclick="delType(this,${id })" class="vulnControl vulnControl-delete">
	  			...
	  			<bs:mco colsize="12">
	  				<bs:datatable columns="Name,Options" classname="" id="campaign">
	  					<s:iterator value="campaigns">
	  						...
	  						<td width="100px">
	  						<span onclick="editCampaign(this,${id })" class="vulnControl">
	  								<i class="fa fa-edit"></i>
	  							</span>
	  						<span onclick="delCampaign(this,${id })" class="vulnControl vulnControl-delete">
								<i class="fa fa-trash"></i>
							</span>
	  						</td></tr>
	  					</s:iterator>
	 ...
	 <bs:box type="primary" title="Custom Fields">
	  			...
	  			<bs:mco colsize="12">
	  				<bs:datatable columns="Name,Variable,Default,Field Type,Applied To,ReadOnly,Edit" classname="" id="campaign">
	  					<s:iterator value="custom">
	  						...
	  						<td>
	  						<span for="${id}" class="vulnControl updCF"><i class="fa fa-save"></i></span>
	  						<span for="${id}" class="vulnControl vulnControl-delete delCF"><i class="fa fa-trash"></i></span>
	  						</td></tr>
	  					</s:iterator>
	  	...
	  	<s:if test="acadmin == true">
	  	 <bs:box type="primary" title="Configuration Settings">
	  		...
	  		<div class="col-md-6">
	  			<div class="checkbox">
	                      <label>
	                        <input type="checkbox" id="prEnabled" ${prChecked }> Enable PeerReview Queue
	                      </label>
	           </div>
	           </div>
	           <div class="col-md-6">
	           ...
	           <div class="col-md-6">
	  			<div class="checkbox">
	                      <label>
	                        <input type="checkbox" id="randEnabled" ${randChecked }> Allow Random AppId
	                      </label>
	           </div>
	           </div>
	  	...
	  	<bs:box type="primary" title="Assessment Status">
		  	...
		  	<s:iterator value="EMS.status" var="stat" >
		  		...
		  		<td width="50px" status="<s:property value="stat"/>">
		  			<s:if test="#stat == EMS.defaultStatus">
		  		...
		  		<td width="50px">
	  			<span class="vulnControl vulnControl-delete"  onClick="deleteStatus('<s:property value="stat"/>')"><i class="fa fa-trash"></i></span>
	  			</td>
	  			</tr>
		  	</s:iterator>
		  	</bs:datatable>
	  ...
	  <bs:mco colsize="6">
	  	<bs:box type="info" title="Email Settings">
	  		<bs:row>
	  			<bs:inputgroup name="Email Server:" colsize="12" id="emailServer" placeholder="Email Server Address"><s:property value="EMS.server"/></bs:inputgroup>
	  			<bs:inputgroup name="Email Port:" colsize="12" id="emailPort" placeholder="Email Server Port"><s:property value="EMS.port"/></bs:inputgroup>
	  			<bs:inputgroup name="Email Protocol:" colsize="12" id="emailProto" placeholder="smtp,pop,imap"><s:property value="EMS.type"/></bs:inputgroup>
	  			<div class="col-md-12">
		  			<div class="checkbox">
	                      <label>
	                        <input type="checkbox" id="isAuth" ${authChecked} > Use Authentication
	                      </label>
	                      <label>
	                        <input type="checkbox" id="isTLS" ${tlsChecked} > Use TLS
	                      </label>
	                       <label>
	                        <input type="checkbox" id="isSSL" ${sslChecked} > Use SSL
	                      </label>
	                </div>
                </div>
	  			<bs:inputgroup name="Account Username (Sender Account if UnAuthenticated):" colsize="12" id="emailName" placeholder="Username"><s:property value="EMS.uname"/></bs:inputgroup>
	  			<bs:inputgroup name="Email from Address:" colsize="12" id="fromAddress" placeholder="From Address"><s:property value="EMS.fromaddress"/></bs:inputgroup>
	  			<bs:inputgroup name="Account Password:" colsize="12" id="emailPass" placeholder="Password" password="true">*****</bs:inputgroup>
	  			<bs:inputgroup name="Email Subject Prefix: " colsize="12" id="emailPrefix" placeholder="Faction : "><s:property value="EMS.prefix"/></bs:inputgroup>
	  			<bs:mco colsize="12">
	  			<div class="form-group">
	  				<label>Email Signature:</label>
	  				<textarea rows="12" cols="100" class="form-control pull-right" name="emailSignature" id="emailSignature"><s:property value="EMS.signature"/></textarea>
	  			</div>
	  			</bs:mco>
	  			<br>
	  			<br>
